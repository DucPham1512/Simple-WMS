...
namespace InternProj.Data
{
    ...
    public class PhieuNhapKhoRepository
    {
        ...
        public async Task<List<PhieuNhapKhoHeader>> ListAsync()
        {
            ...
            while (await reader.ReadAsync())
            {
                item.Add(new PhieuNhapKhoHeader
                {
                    ...
                    Ngay_Nhap_Kho = DateTime.ParseExact(reader.GetString(6),"dd/MM/yyyy",CultureInfo.InvariantCulture),
        ...
        public async Task<List<PhieuNhapKhoData>> GetAsync(int nhapKhoId)
        {
            ...
            while (await reader.ReadAsync())
            {
                result.Add(new PhieuNhapKhoData
                {
                    ...
                    NgayNhapKho = DateTime.ParseExact(reader.GetString(1), "dd/MM/yyyy", CultureInfo.InvariantCulture),
        ...
        ";
                ...
                insertHeader.Parameters.AddWithValue("@ngay", ngay.ToString("dd/MM/yyyy"));
        ...
        public async Task<int> EditHeaderAsync(PhieuNhapKhoHeader item)
        {
            ...
            cmd.Parameters.AddWithValue("@ngay", item.Ngay_Nhap_Kho.ToString("dd/MM/yyyy"));
